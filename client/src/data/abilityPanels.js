...
export const ABILITY_PANELS = {
  ...
  CHAMBERMAID: { phases: NIGHT, targets: 2, number: [0, 2],
  ...
  SEAMSTRESS: { phases: NIGHT, targets: 2, toggle: ['Misma alineación', 'Distinta alineación'], once: 'seamstressUsed',
    note: 'Una vez por partida.' },
  ...
  LLEECH: { phases: NIGHT, targets: 1, action: 'LLEECH_KILL',
    note: 'Elige anfitrión la primera noche: queda envenenado y si muere, la Sangijuela muere.' },
