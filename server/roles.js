...
function getDistribution(playerCount, selectedRoles) {
  const dist = { ...BASE_DISTRIBUTION[playerCount] } || { townfolk: 3, outsiders: 0, minions: 1, demons: 1 };
...
module.exports = { ROLES, BASE_DISTRIBUTION, getDistribution, getRolesByType };
