...
export const ABILITY_PANELS = {
  ...
  ARTIST: { phases: DAY, targets: 0, freeText: 'Respuesta', toggle: ['SÍ', 'NO'], once: 'artistUsed', privateRoom: true,
    note: 'Responde en privado a una pregunta de sí o no. También vale "no lo sé".' },
  SAVANT: { phases: DAY, targets: 0, twoTexts: ['Afirmación verdadera', 'Afirmación falsa'], privateRoom: true,
  ...
  AMNESIAC: { phases: '*', targets: 0, privateRoom: true,
    setText: { action: 'AMNESIAC_SET', label: 'Habilidad secreta que le has asignado', button: '💾 Fijar habilidad' },
    scale: {
      action: 'AMNESIAC_GUESS', label: '¿Cómo de cerca está su suposición de hoy?',
      options: [
  ...
  FISHERMAN: { phases: DAY, targets: 0, freeText: 'Consejo', once: 'fishermanUsed', privateRoom: true,
    note: 'Dale un consejo en privado. Envenenado, dale uno inútil.' },
  GENERAL: { phases: NIGHT, targets: 0,
    scale: {
      action: 'GENERAL_INFO', label: '¿Qué bando crees que va ganando?',
      options: [
  ...
  HIGH_PRIESTESS: { phases: NIGHT, targets: 1, action: 'HIGH_PRIESTESS',
    note: 'Señala libremente al jugador con quien creas que debería hablar. Es TU criterio.' },
  HUNTSMAN: { phases: NIGHT, targets: 1, action: 'HUNTSMAN', once: 'huntsmanUsed',
  ...
  DAMSEL: { phases: '*', targets: 1, action: 'DAMSEL_GUESS', once: 'damselGuessUsed',
  ...
  POLITICIAN: { phases: '*', targets: 0, action: 'POLITICIAN_SWITCH',
  ...
  PUZZLEMASTER: { phases: '*', targets: 1, privateRoom: true,
  ...
  YAGGABABBLE: { phases: NIGHT, targets: 5, freeText: 'Frase secreta', action: 'YAGGABABBLE_KILL',
  ...
  PIXIE: { phases: NIGHT, targets: 1, pickRole: true, madness: true, action: 'PIXIE_INFO',
  ...
  VILLAGE_IDIOT: { phases: NIGHT, targets: 1, action: 'VILLAGE_IDIOT_INFO', toggle: ['Es BUENO', 'Es MALVADO'],
  ...
  OGRE: { phases: NIGHT, targets: 1, excludeSelf: true, action: 'OGRE_ALIGN',
    note: 'Toma la alineación del elegido. Cámbiala en SILENCIO: nunca debe saberlo.' },
  GNOME: { phases: NIGHT, targets: 1, action: 'GNOME_KNOWN',
  ...
  LORD_OF_TYPHON: { phases: NIGHT, targets: 1, action: 'LORD_OF_TYPHON_KILL',
    note: 'Los malvados van en línea con él en el centro. +1 Esbirro. Valida los asientos en el montaje.' },
  FIDDLER: { phases: NIGHT, targets: 1, action: 'FIDDLER_DUEL', once: 'fiddlerUsed',
  ...
  XAAN: { phases: NIGHT, targets: 0, action: 'XAAN_POISON',
  ...
  BUREAUCRAT: { phases: NIGHT, targets: 1, excludeSelf: true, action: 'BUREAUCRAT_VOTE',
    note: 'Mañana el voto del elegido cuenta por 3.' },
  THIEF: { phases: NIGHT, targets: 1, excludeSelf: true, action: 'THIEF_VOTE',
